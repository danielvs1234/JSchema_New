...
public class JSchemaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JSchemaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExtendedObjectAccess().getGroup_5_1(), "rule__ExtendedObject__Group_5_1__0");
			builder.put(grammarAccess.getExtendedPropertiesAccess().getGroup(), "rule__ExtendedProperties__Group__0");
			...
			builder.put(grammarAccess.getExtendedObjectAccess().getBodyAssignment_5_0(), "rule__ExtendedObject__BodyAssignment_5_0");
			builder.put(grammarAccess.getExtendedObjectAccess().getBodyAssignment_5_1_1(), "rule__ExtendedObject__BodyAssignment_5_1_1");
			builder.put(grammarAccess.getExtendedPropertiesAccess().getOverrideAssignment_0(), "rule__ExtendedProperties__OverrideAssignment_0");
			builder.put(grammarAccess.getExtendedPropertiesAccess().getExtendedPropertiesAssignment_1(), "rule__ExtendedProperties__ExtendedPropertiesAssignment_1");
			...
			builder.put(grammarAccess.getPropertyAccess().getPropExtObjAssignment_2(), "rule__Property__PropExtObjAssignment_2");
